const ageCalculate = () => {
    ...
    const inputDate = new Date(document.getElementById
        ("date-input").value);
    ...
    if (isFutureDate(birthDetails, currentYear,
...
const isFutureDate = (birthDetails, currentYear, 
    currentMonth, currentDate ) => {
        return(
...
const calculateAge = (birthDetails, currentYear,
    currentMonth, currentDate) => {
        ...
        if (currentDate < birthDetails.date) {
            ...
            days = daysInLastMonth - (birthDetails.date -
                currentDate);
             } else {
...
document.getElementById("cale-age-btn").
